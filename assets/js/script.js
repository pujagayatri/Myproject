...
a.onmouseover=function abc(){
    document.getElementById('first').style.cssText="background-color:#e5faf9;border:1px solid rgb(62,152,62);height:70px;";
}
...
b.onmouseover=function abc(){
    document.getElementById('second').style.cssText="background-color:#e5faf9;border:1px solid rgb(62,152,62);height:130px; ";
}
...
c.onmouseover=function abc(){
    document.getElementById('third').style.cssText="background-color:#e5faf9; height:70px;border:1px solid rgb(62,152,62);";
}
